...
async function main() {
    ...
    const deliveryPage = await prisma.page.upsert({
        ...
        create: {
            ...
            metaDescription: 'Доставка и оплата от компании Interest Mebel',
    ...
    const montagePage = await prisma.page.upsert({
        ...
        create: {
            ...
            metaDescription: 'Сборка и монтаж от компании Interest Mebel',
    ...
    const montageConditionsPage = await prisma.page.upsert({
        ...
        create: {
            ...
            metaDescription: 'Условия монтажа от компании Interest Mebel',
    ...
    const warrantyPage = await prisma.page.upsert({
        ...
        create: {
            ...
            alias: 'garantiya',
            metaTitle: 'Гарантия',
            metaDescription: 'Гарантия от компании Interest Mebel',
